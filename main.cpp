...
int main() {
    ...
    if (mainFont == nullptr) {
        ...
        // You might want to exit the application or load a fallback font here
    }
    ...
    style.Colors[ImGuiCol_Text] = ImVec4(0.00f, 0.00f, 0.00f, 1.00f);  // צבע טקסט
    style.Colors[ImGuiCol_WindowBg] = ImVec4(0.9961f, 0.9529f, 0.8863f, 1.0f);//צבע חלון ראשי
    style.Colors[ImGuiCol_PopupBg] = ImVec4(0.9961f, 0.9529f, 0.8863f, 1.0f);  // צבע רקע חלון קופץ
    style.Colors[ImGuiCol_Border] = ImVec4(0.43f, 0.43f, 0.50f, 0.50f);  // צבע גבול
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.7451f, 0.7765f, 0.6275f, 1.0f); // צבע רקע מסגרת
    style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.3765f, 0.4000f, 0.4627f, 1.0f);  // צבע רקע מסגרת במעבר עכבר
    style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.67f, 0.67f, 0.67f, 0.39f);  // צבע רקע מסגרת פעילה
    style.Colors[ImGuiCol_TitleBg] = ImVec4(0.08f, 0.08f, 0.09f, 1.00f);  // צבע רקע כותרת
    style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.9961f, 0.9529f, 0.8863f, 1.0f);  // צבע רקע כותרת פעילה
    style.Colors[ImGuiCol_Button] = ImVec4(0.78f, 0.78f, 0.78f, 0.67f);  // צבע כפתור
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.3765f, 0.4000f, 0.4627f, 1.0f);   // צבע כפתור במעבר עכבר
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.3765f, 0.4000f, 0.4627f, 1.0f);// צבע כפתור פעיל
